        ...
        with dpg.collapsing_header(label=header3_label):
            with dpg.group(horizontal=True):
                ...
                with dpg.group():
                    ...
                    with dpg.group(horizontal=True):
                        dpg.add_button(
                            label=DISPLAY_TEXTS["ui_assignment_browser"][
                                LANGUAGE.get()
                            ],
                            callback=open_assignment_browse,
        ...
        with dpg.collapsing_header(label=header1_label, default_open=True):
            ...
            with dpg.group(horizontal=True):
                ...
                with dpg.group():
                    ...
                    dpg.add_listbox(_vars, tag=UI_ITEM_TAGS["VARIATION_GROUP"], width=BOX_LARGE)
            ...
            with dpg.group(horizontal=True):
                ...
                with dpg.group():
                    ...
                    with dpg.group():
                        ...
                        dpg.add_listbox(
                            prev, num_items=2, enabled=enable, tag=listbox_tag, width=BOX_LARGE
                        )
